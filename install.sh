...
readonly REPO_URL="https://github.com/erffy-dots/fastfetch.git"
readonly CONFIG_DIR="$HOME/.config/fastfetch"
...
echo "Downloading Fastfetch configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Fastfetch configuration detected at '$CONFIG_DIR'."
...
echo "You may need to install additional dependencies for Fastfetch."
echo "Refer to the Fastfetch documentation for more information."
